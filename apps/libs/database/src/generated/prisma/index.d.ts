...
export namespace Prisma {
  ...
  */
  ...
  export type FlightOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"flightId" | "pnr" | "status" | "total" | "currency" | "passengerName" | "passengerEmail" | "itineraryId" | "createdAt", ExtArgs["result"]["flight"]>
  ...
  export interface FlightDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const flightWithFlightIdOnly = await prisma.flight.findMany({ select: { flightId: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Flights and only return the `flightId`
     * const flightWithFlightIdOnly = await prisma.flight.createManyAndReturn({
     ...
     * })
     * 
     * // Update zero or more Flights and only return the `flightId`
     * const flightWithFlightIdOnly = await prisma.flight.updateManyAndReturn({
     *   select: { flightId: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface FlightFieldRefs {
    readonly flightId: FieldRef<"Flight", 'String'>
    readonly pnr: FieldRef<"Flight", 'String'>
    readonly status: FieldRef<"Flight", 'FlightStatus'>
    readonly total: FieldRef<"Flight", 'Float'>
    readonly currency: FieldRef<"Flight", 'String'>
    readonly passengerName: FieldRef<"Flight", 'String'>
    readonly passengerEmail: FieldRef<"Flight", 'String'>
    readonly itineraryId: FieldRef<"Flight", 'String'>
  ...
  export type HotelOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"hotelId" | "reservation_id" | "status" | "total" | "currency" | "guestName" | "guestEmail" | "checkIn" | "checkout" | "createdAt", ExtArgs["result"]["hotel"]>
  ...
  export interface HotelDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const hotelWithHotelIdOnly = await prisma.hotel.findMany({ select: { hotelId: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Hotels and only return the `hotelId`
     * const hotelWithHotelIdOnly = await prisma.hotel.createManyAndReturn({
     *   select: { hotelId: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more Hotels and only return the `hotelId`
     * const hotelWithHotelIdOnly = await prisma.hotel.updateManyAndReturn({
     *   select: { hotelId: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface HotelFieldRefs {
    readonly hotelId: FieldRef<"Hotel", 'String'>
    readonly reservation_id: FieldRef<"Hotel", 'String'>
    readonly status: FieldRef<"Hotel", 'HotelStatus'>
    readonly total: FieldRef<"Hotel", 'Float'>
    readonly currency: FieldRef<"Hotel", 'String'>
    readonly guestName: FieldRef<"Hotel", 'String'>
    readonly guestEmail: FieldRef<"Hotel", 'String'>
    readonly checkIn: FieldRef<"Hotel", 'DateTime'>
    readonly checkout: FieldRef<"Hotel", 'DateTime'>
  ...
  export type FlightWhereInput = {
    ...
    flightId?: StringFilter<"Flight"> | string
    pnr?: StringFilter<"Flight"> | string
    status?: EnumFlightStatusFilter<"Flight"> | $Enums.FlightStatus
    total?: FloatFilter<"Flight"> | number
    currency?: StringFilter<"Flight"> | string
    passengerName?: StringFilter<"Flight"> | string
    passengerEmail?: StringFilter<"Flight"> | string
    itineraryId?: StringFilter<"Flight"> | string
  ...
  export type FlightScalarWhereWithAggregatesInput = {
    ...
    flightId?: StringWithAggregatesFilter<"Flight"> | string
    pnr?: StringWithAggregatesFilter<"Flight"> | string
    status?: EnumFlightStatusWithAggregatesFilter<"Flight"> | $Enums.FlightStatus
    total?: FloatWithAggregatesFilter<"Flight"> | number
    currency?: StringWithAggregatesFilter<"Flight"> | string
    passengerName?: StringWithAggregatesFilter<"Flight"> | string
    passengerEmail?: StringWithAggregatesFilter<"Flight"> | string
    itineraryId?: StringWithAggregatesFilter<"Flight"> | string
  ...
  export type HotelWhereInput = {
    ...
    hotelId?: StringFilter<"Hotel"> | string
    reservation_id?: StringFilter<"Hotel"> | string
    status?: EnumHotelStatusFilter<"Hotel"> | $Enums.HotelStatus
    total?: FloatFilter<"Hotel"> | number
    currency?: StringFilter<"Hotel"> | string
    guestName?: StringFilter<"Hotel"> | string
    guestEmail?: StringFilter<"Hotel"> | string
    checkIn?: DateTimeFilter<"Hotel"> | Date | string
    checkout?: DateTimeFilter<"Hotel"> | Date | string
  ...
  export type HotelScalarWhereWithAggregatesInput = {
    ...
    hotelId?: StringWithAggregatesFilter<"Hotel"> | string
    reservation_id?: StringWithAggregatesFilter<"Hotel"> | string
    status?: EnumHotelStatusWithAggregatesFilter<"Hotel"> | $Enums.HotelStatus
    total?: FloatWithAggregatesFilter<"Hotel"> | number
    currency?: StringWithAggregatesFilter<"Hotel"> | string
    guestName?: StringWithAggregatesFilter<"Hotel"> | string
    guestEmail?: StringWithAggregatesFilter<"Hotel"> | string
    checkIn?: DateTimeWithAggregatesFilter<"Hotel"> | Date | string
    checkout?: DateTimeWithAggregatesFilter<"Hotel"> | Date | string
